...
- [x] Эндпойнт добавления сменных заданий __/api/task/__
- [x] Эндпойнт получения сменного задания по ID __/api/task/{id}__
- [x] Эндпойнт изменения сменного задания по ID __/api/task/{task_id}__
- [x] Эндпойнт получения списка сменных заданий по фильтрам __/api/task?close_status=false__
- [x] Эндпойнт "аггрегации" продукции __/api/product?product_id=6&task_id=8__
...
Опишите, как запустить ваш проект и как запустить тесты (если они есть).
	...
	Запустить cmd из папки с проектом - прописать docker-compose up
